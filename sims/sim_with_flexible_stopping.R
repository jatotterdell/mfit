...
cfg <- data.table(
  ...
  eff_eps = function(t) 0.9^sqrt(t),
  fut_eps = 0.950,
  sup_eps = function(t) 0.9^sqrt(t),
  brar = TRUE,
  allow_stopping = TRUE,
  means = mean_cfg,
...
cfg2 <- copy(cfg)[, `:=`(eff_eps = function(t) 0.95^sqrt(t), sup_eps = function(t) 0.95^sqrt(t))]
cfg3 <- copy(cfg)[, `:=`(eff_eps = function(t) 0.975^sqrt(t), sup_eps = function(t) 0.975^sqrt(t))]
